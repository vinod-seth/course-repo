...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/vinod-seth/course-repo/blob/main/tutorial/06-CD-DEPLOYMENT-STRATEGIES.md)
...
**Question 1:** What is the core objective of CD Deployment Strategies in modern DevOps practices?
...
**Explanation:** CD Deployment Strategies focuses on improving agility, reducing delivery friction, and ensuring operational reliability.
</details>

**Question 2:** Which file format is standard for defining automated workflows and pipelines associated with CD Deployment Strategies?
...
**Question 5:** What is a major benefit of Infrastructure as Code (IaC) when configuring CD Deployment Strategies?
...
**Question 8:** When a production deployment fails, what is the fastest way to restore service stability when using CD Deployment Strategies?
